       select array_to_json(array_agg(row_to_json(t)))
        ...
        COUNT(tp2.text_id) * 100.0 / (SELECT distinct COUNT(text_id) FROM core.text_property WHERE property_name = 'korpus' AND property_value IN ('cFOoRQekA','cFqPphvYi')) AS protsent
        ...
        WHERE tp1.property_name = 'korpus' AND tp1.property_value IN ('cFOoRQekA','cFqPphvYi') AND
         tp2.property_name = 'tekstikeel' AND tp3.property_name = 'sonu' AND tp4.property_name = 'lauseid'
